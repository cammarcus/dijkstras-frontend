  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-100 p-4">
      ...
      <div className="mt-8 text-md text-gray-600 p-4">
        ...
        <p>Built with React, styled with Tailwind CSS, and powered by a Node.js and Express backend. Both the frontend and backend are running on an AWS EC2 instance. The backend handles the logic and calculations, while the frontend provides a user-friendly interface for interaction.</p>
      </div>
    </div>
  );
}
